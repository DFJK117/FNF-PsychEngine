...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var options:Array<Dynamic> = [
		...
		[true, 'P1 NOTES'],
		[true, 'P1 Left', 'doubao_p1_left', 'P1 Left'],
		[true, 'P1 Down', 'doubao_p1_down', 'P1 Down'],
		[true, 'P1 Up', 'doubao_p1_up', 'P1 Up'],
		[true, 'P1 Right', 'doubao_p1_right', 'P1 Right'],
		[true],
		[true, 'P2 NOTES'],
		[true, 'P2 Left', 'doubao_p2_left', 'P2 Left'],
		[true, 'P2 Down', 'doubao_p2_down', 'P2 Down'],
		[true, 'P2 Up', 'doubao_p2_up', 'P2 Up'],
		[true, 'P2 Right', 'doubao_p2_right', 'P2 Right'],
		[true],
		[true, 'UI'],
